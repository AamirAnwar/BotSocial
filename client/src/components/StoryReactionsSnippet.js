    ...
    return (
      <div className="story_reactions">
        <span>
          ...
          <button id={`like_${story._id}`} className="btn btn-dark like_button" name="button">
          ...
          {/* <!-- Dislikes button --> */}
          <button className="btn btn-dark dislike_button" name="button" id={`dislike_${story._id}`}>
            <span className='dislike_count'>{story.dislikes.length}</span>
            <i className="fa fa-thumbs-down"></i>
          </button>

          {/* <!-- Comments button --> */}
          <button className="btn btn-dark comments_button" data-toggle="modal" data-target="#modal_<%=stories[i]._id%>" name="button" id={`comments_button_${story._id}`}>
